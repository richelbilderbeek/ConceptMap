...
{
  concept.SetRatingComplexity(rating_complexity);
}
...
{
  concept.SetRatingConcreteness(rating_concreteness);
}
...
{
  concept.SetRatingSpecificity(rating_specificity);
}
